...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nionswift-usim-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8850&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nionswift-usim-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nionswift-usim` can be installed with:

```
conda install nionswift-usim
```

It is possible to list all of the versions of `nionswift-usim` available on your platform with:
